...
def upgrade() -> None:
    ...
    sa.Column('season', sa.Enum('winter', 'spring', 'summer', 'autumn', name='season'), nullable=True),
    sa.Column('category', sa.Enum('apero', 'entree', 'plat', 'dessert', name='category'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['recipe_id'], ['recipes.id'], name=op.f('fk_images_recipe_id_recipes'), ondelete='CASCADE'),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('type', sa.Enum('manual', 'instagram', 'url', 'photo', name='sourcetype'), nullable=False),
    sa.Column('raw_content', sa.Text(), nullable=False),
    sa.Column('recipe_id', sa.Uuid(), nullable=True),
    sa.ForeignKeyConstraint(['recipe_id'], ['recipes.id'], name=op.f('fk_sources_recipe_id_recipes'), ondelete='SET NULL'),
