    ...
    <div className="min-h-[100dvh] flex flex-col bg-background overflow-x-hidden font-body">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/80 border-b border-border/40">
        <div className="flex items-center justify-between h-14 px-4 md:px-6">
          ...
          {/* Desktop: navbar Google login */}
          <div className="hidden md:block relative">
            <div className="absolute inset-0 opacity-0 z-10 overflow-hidden rounded-full [&_iframe]:!w-full [&_iframe]:!h-full">
              <GoogleLogin
                onSuccess={(r) => { if (r.credential) handleLogin(r.credential); }}
            ...
            <span className="relative inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-foreground text-background text-sm font-body font-semibold cursor-pointer transition-all hover:bg-foreground/85 active:scale-95">
              Se connecter
            </span>
          </div>
        </div>
      ...
      <section className="relative flex-1 flex flex-col items-center justify-center px-5 pt-20 pb-16">
        ...
        <div className="relative z-20 max-w-3xl mx-auto text-center">
          ...
          <div className="anim-hero4 mt-10 flex flex-col items-center gap-3">
            {/* Desktop: Commencer gratuitement with hidden Google login */}
            <div className="hidden md:block relative inline-flex">
              {isLoggingIn ? (
                ...
                <>
                  ...
                  <span className="cta-btn relative inline-flex items-center gap-2.5 px-8 py-4 rounded-full text-white font-body font-semibold text-lg cursor-pointer select-none transition-all duration-300 hover:scale-[1.03] hover:shadow-xl active:scale-[0.98]">
            ...
            {/* Mobile: orange button with hidden Google login behind it */}
            <div className="md:hidden relative inline-flex">
              {isLoggingIn ? (
                ...
                <>
                  ...
                  <span className="relative inline-flex items-center justify-center gap-2 w-[280px] py-3.5 rounded-full bg-primary text-white font-body font-semibold text-base cursor-pointer select-none">
                    <svg className="w-5 h-5" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#fff"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#fff"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#fff"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#fff"/></svg>
                    Se connecter
                  </span>
                </>
              )}
